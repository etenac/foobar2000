...
function BottomPanel() {
    this.on_paint = function (gr) {
        ...
        // SeekBar
        {
            ...
            var seekbar_text_font = gdi.Font('Consolas', 22, 1);//14
    ...
    function create_button_images() {
        var fontGuifx = gdi.Font(g_guifx.name, 24);//18
        var c = [250, 250, 250];
        ...
        var accent_ico_colors =
            [
                _.RGBA(255, 165, 8, 155),
                _.RGBA(255, 165, 8, 225),
                _.RGBA(255, 165, 8, 105)
            ];
    ...
    var seekbar_h = 21;
    /** @const {number} */
    var seekbar_text_w = (g_properties.minify_seekbar ? 65 : 80); // 70
    /** @const {number} */
    var volume_bar_h = 21;
    /** @const {number} */
    var volume_bar_w = 70;
